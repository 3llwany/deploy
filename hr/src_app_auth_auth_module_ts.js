    ...
    onSubmit() {
        ...
        if (this.form.valid) {
            ...
            this.authService.login(bodyRequest).subscribe((res) => {
                ...
                this.errorList(error?.message?.messages);
            });
        }
    }
}
LoginPageComponent.ɵfac = function LoginPageComponent_Factory(t) { return new (t || LoginPageComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_8__.ActivatedRoute)); };
LoginPageComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({ type: LoginPageComponent, selectors: [["app-login-page"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵInheritDefinitionFeature"]], decls: 30, vars: 18, consts: [[1, "card", "flex", "justify-content-center", "gap-2"], ["id", "login"], [1, "row", "auth-height", "full-height-vh", "m-0"], [1, "col-12", "d-flex", "align-items-center", "justify-content-center"], [1, "card", "overflow-hidden"], [1, "card-content"], [1, "card-body", "auth-img"], [1, "row", "m-0"], [1, "col-lg-6", "d-none", "d-lg-flex", "justify-content-center", "align-items-center", "auth-img-bg", "p-3"], ["alt", "login", "width", "300", "height", "230", 1, "img-fluid", 3, "src"], [1, "col-lg-6", "col-12", "px-4", "py-3"], [1, "mb-2", "card-title"], ["type", "light-danger", "class", "mb-2", 3, "close", 4, "ngIf"], [3, "formGroup"], [1, "row", "mb-2"], [1, "col-12"], ["label", "email", "type", "email", 3, "control", "submitted", "appearance"], ["type", "password", "label", "password", 3, "control", "submitted", "appearance"], [1, "mt-2"], [1, "btn", "btn-info", "p-2", "mb-1", "btn-block", "text-center", 3, "click"], ["type", "light-danger", 1, "mb-2", 3, "close"], [1, "mb-0"]], template: function LoginPageComponent_Template(rf, ctx) { if (rf & 1) {
